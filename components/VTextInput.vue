...
.w-full
  ValidationProvider(
    ...
    input.border-none.p-0.text-neutral-600.gap-1.border.bg-white.py-2.px-4.text-neutral-400.l-inline-start-center-nowrap.w-full(
      ref='input' class='placeholder:text-neutral-400 focus:border-none focus:outline-none focus:ring-0 focus:ring-offset-0 disabled:bg-neutral-200 rounded-[10px] border-[#E0E0E0]' 
      type='text' 
      v-bind="{ autocomplete: 'off', type: 'text', ...$attrs }" 
      @input='handleInput' 
      @change='handleChange'
